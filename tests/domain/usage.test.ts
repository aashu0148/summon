...
import { parseUsage, limitLabel, usageBar, formatReset, type RawUsage } from "../../src/domain/usage.ts";
...
test("parseUsage maps every bucket with a percent to a labelled row", () => {
  ...
  expect(rows).toEqual([
    { label: "Current session", percent: 61, severity: "normal", resetsAt: "2026-07-07T11:49:59.897314+00:00" },
    { label: "Weekly (all models)", percent: 55, severity: "normal", resetsAt: "2026-07-10T15:59:59.897336+00:00" },
    { label: "Weekly · Fable", percent: 12, severity: "normal", resetsAt: "2026-07-10T15:59:59.897651+00:00" },
  ]);
});
